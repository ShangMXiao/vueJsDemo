<template>
    <div>
		  ...
		  <div class="container">
		    <div class="checkout-addr">
		      ...
		      <div class="addr-list-wrap">
		        <div class="addr-list">
		          <ul>
		            <li v-for="(item, index) in addressListFilter" v-bind:class="{'check': checkedIndex == index}" @click="checkedIndex = index; selectAddrId = item.addressId">
		              <dl>
		                <dt>{{item.userName}}</dt>
		...
		<modal v-bind:mdShow="isModalShow">
			<p slot="message">
				你确认要删除此条地址？
			</p>
			<div slot="btnGroup">
		...
		<modal v-bind:mdShow="isModalShow2" @close="isModalShow2 = false">
			<p slot="message">
				地址列表至少需要一条数据，已经无法删除！
			</p>
			<div slot="btnGroup">
				<a href="javascript:;" class="btn btn--m" @click="isModalShow2 = false">好的</a>
			</div>
		</modal>
