<template>
  <div>
	          ...
	          <li v-for="item in cartList">
	            <div class="cart-tab-1">
	              ...
	              <div class="cart-item-pic">
	                <img v-bind:src="'/static/' + item.productImage" v-bind:alt="item.prductName">
	              </div>
	...
	<modal v-bind:mdShow="modalComfirm" @close="closeModal">
        <p slot="message">
          你确定要删除此条数据吗？
        </p>
        <div slot="btnGroup">
          <a href="javascript:;" class="btn btn--m" @click="delCart">确定</a>
          <a href="javascript:;" class="btn btn--m" @click="modalComfirm=false">取消</a>
        </div>
     </modal> 
